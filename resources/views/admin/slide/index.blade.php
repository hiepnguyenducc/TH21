                        ...
                        @foreach($slide as $index => $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('admin/slide/'.$item->id.'/delete')}}" onclick="return confirm('Are you sure, you want to delete this data ?')" class="btn btn-danger" data-bs-target="#deleteModal">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
