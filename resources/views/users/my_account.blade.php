                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="account-tab" role="tabpanel" aria-labelledby="account-nav">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <input class="form-control" type="text" placeholder="First Name" value="{{$user->name}}">
                                    </div>
                                    <div class="col-md-6">
                                        <input class="form-control" type="text" placeholder="Image" value="{{$user->image}}">
                                    </div>
                                    <div class="col-md-6">
                                        <input class="form-control" type="text" placeholder="Mobile" value="{{$user->phone}}">
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <input class="form-control" type="password" placeholder="Current Password" value="{{$user->password}}">
                                    </div>
                                    <div class="col-md-6">
